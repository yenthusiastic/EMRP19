 ...
 * Modified to use VL6180X instead of VL53L0X
 * Removed CayenneLPP usage due to incopatibility with v1
 ...
 * Modified by Thu Nguyen 08.01.2020
 */
...
#define SLEEP_TIME_IN_SEC 300       // Time ESP32 will go to sleep (in seconds)
...
Adafruit_VL6180X lox = Adafruit_VL6180X(); // time-of-flight infarred sensor
// CayenneLPP lpp(51);
...
static const u1_t PROGMEM DEVEUI[8] = { 0x00, 0x00, 0xC9, 0x23, 0x8D, 0x2D, 0xE6, 0xB4 };
...
// 
static const u1_t PROGMEM APPKEY[16] = { 0x55, 0xAD, 0x74, 0xD5, 0xE3, 0x2F, 0xF3, 0x8C, 0x5A, 0x47, 0x28, 0x3B, 0x2F, 0x33, 0x17, 0xFF };
