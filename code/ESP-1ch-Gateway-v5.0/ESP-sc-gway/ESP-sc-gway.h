...
#define _TTNPORT 1883						// Standard port for TTN
...
#define _DESCRIPTION "EMRP19 Gateway"			// Name of the gateway
#define _EMAIL "emrp@hsrw.org"		// Owner
#define _PLATFORM "Heltec-ESP32-Dev-V1"
#define _LAT 51.49
#define _LON 6.54
